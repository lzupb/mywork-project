"ace"in window || (window.ace = {}), "helper"in window.ace || (window.ace.helper = {}), "options"in window.ace || (window.ace.options = {}), "vars"in window.ace || (window.ace.vars = {icon: " ace-icon ", ".icon": ".ace-icon"}), ace.vars.touch = "ontouchstart"in document.documentElement, jQuery(function (e) {
    ...
    function s(a, t) {
        ...
        if (i.length > 0)document.title = i.text(), i.remove(); else if (a.length > 0) {
    ...
    if (e.fn.ace_scroll) {
        ...
        if (l && c) {
            var d, u, h = null, v = null, p = null, f = null, g = null, m = !1, b = !1, w = a.scroll_to_active || !1, _ = a.include_shortcuts || !1, y = a.include_toggle || !1, C = a.smooth_scroll || !1, x = a.outside || !1, k = "getComputedStyle"in window ? function () {
                ...
                if (m && !ace.vars.minimized)if (H.content_height() + e < H.available_height())H.disable(); else if (0 > e) {
                    var a = v.scrollTop() + e;
                    if (0 > a)return;
                    c.style.top = -1 * a + "px"
                }
    ...
    function t(a) {
        ...
        if ((v = p - (f + r - 50)) > 0)if (u > h - v && n.top - v > c)a.style.top = "auto", a.style.bottom = "-10px", s && (s.style.marginTop = -(h - 50) + "px", o = !0); else {
    ...
    e("#ace-settings-btn").on(ace.click_event, function (a) {
        ...
        if (!e(".sidebar").hasClass("h-sidebar")) {
            if (this.checked)e("#sidebar li").addClass("hover").filter(".open").removeClass("open").find("> .submenu").css("display", "none"); else {
    ...
    e("#skin-colorpicker").on("change", function () {
        ...
        /** 修改 20140820 把选择皮肤记录在cookie ---begin--- **/
        ace.cookie.set("ace_skin-colorpicker", e(this).val(), ace.config.cookie_expiry, "/");
