...
(function (b) {
    ...
    b.extend(b.jgrid, {version: "4.6.0", htmlDecode: function (b) {
        ...
        var a = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/, l = "string" === typeof f ? f.match(a) : null, a = function (a, b) {
            a = String(a);
                ...
                if ("TABLE" !== this.tagName.toUpperCase())alert("Element is not a table"); else if (void 0 !== document.documentMode && 5 >= document.documentMode)alert("Grid can not be used in this ('quirks') mode!"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                        ...
                        (function () {
                            ...
                            }), q = 0, m ? c.width - p - (d + e * g) !== h && (q = c.width - p - (d + e * g) - h) : m || 1 === Math.abs(c.width - p - (d + e * g)) || (q = c.width - p - (d + e * g)), a.p.colModel[f].width += q - 1, a.p.tblwidth = d + q + e * g + p, a.p.tblwidth > a.p.width && (a.p.colModel[f].width -= a.p.tblwidth - parseInt(a.p.width, 10), a.p.tblwidth = a.p.width))
                        })();
                        ...
                        a.updatepager = function (c, d) {
                            ...
                            if (a.p.scroll) {
                                ...
                                if (e = e.outerHeight() ||
                                    a.grid.prevRowHeight)g = f * e, m = parseInt(a.p.records, 10) * e, b(">div:first", a.grid.bDiv).css({height: m}).children("div:first").css({height: g, display: g ? "" : "none"}), 0 == a.grid.bDiv.scrollTop && 1 < a.p.page && (a.grid.bDiv.scrollTop = a.p.rowNum * (a.p.page - 1) * e);
...
(function (a) {
    a.jgrid.extend({getColProp: function (a) {
        ...
        return this.each(function () {
            ...
            if (!this.ftoolbar) {
                var d = function () {
                    ...
                    h || a(c).jqGrid("setGridParam", {search: k}).trigger("reloadGrid", [
                        {page: 1}
                    ]);
                ...
                a.each(c.p.colModel, function (h) {
                    ...
                    if (this.search) {
                        ...
                        switch (this.stype) {
                            case "select":
                                if (m = this.surl || g.dataUrl)a(l).append(n), a.ajax(a.extend({url: m, dataType: "html", success: function (e) {
                ...
                this.clearToolbar = function (d) {
                    ...
                    n || d && a(c).jqGrid("setGridParam", {search: k}).trigger("reloadGrid", [
                        {page: 1}
                    ]);
        ...
        return this.each(function () {
            ...
            for (c = 0; c < x; c++)if (s = q[c].el, f = a(s), d = m[c], e = {height: "0px", width: q[c].width + "px", display: d.hidden ? "none" : ""}, a("<th>", {role: "gridcell"}).css(e).addClass("ui-first-th-" + this.p.direction).appendTo(n), s.style.width = "", e = w(d.name, b.groupHeaders), 0 <= e) {
                e = b.groupHeaders[e];
                h = e.numberOfColumns;
                g = e.titleText;
                ...
                k.append(s);
                h -= 1
            } else 0 === h ? b.useColSpanStyle ? f.attr("rowspan", "2") : (a("<th>", {role: "columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-" + this.p.direction).css({display: d.hidden ? "none" : "", "border-top": "0 none"}).insertBefore(f), k.append(s)) : (k.append(s), h--);
    ...
    a.extend(a.jgrid, {showModal: function (a) {
        ...
        switch (d) {
            ...
            case "custom":
                ...
                try {
                    if (a.isFunction(b.custom_element))if (p = b.custom_element.call(k, c, b))p = a(p).addClass("customelement").attr({id: b.id,
                        name: b.name}), a(f).empty().append(p); else throw"e2"; else throw"e1";
                } catch (r) {
                    ...
                    t && (a('td[role="gridcell"]', t).each(function (l) {
                        ...
                        if ("cb" !== g && "subgrid" !== g && "rn" !== g && !0 === m[l].editable) {
                            ...
                            switch (m[l].edittype) {
                                ...
                                case "checkbox":
                                    f = String(f);
                                    if (m[l].editoptions && m[l].editoptions.value)if (m[l].editoptions.value.split(":")[0] === f)a("#" + g, "#" + n)[d.p.useProp ? "prop" : "attr"]({checked: !0, defaultChecked: !0}); else a("#" + g, "#" + n)[d.p.useProp ? "prop" : "attr"]({checked: !1, defaultChecked: !1}); else f = f.toLowerCase(), 0 > f.search(/(false|f|0|no|n|off|undefined)/i) && "" !== f ? (a("#" +
            ...
            if ("1" === g) {
                ...
                if ("clientArray" === f.url) {
                    ...
                    if ("success" === e) {
                        ...
                        if (!0 === g) {
                            d.p.autoencode && a.each(k, function (b, d) {
        ...
        return a.each(function () {
            ...
            c(k).each(function () {
                this[b] || (this[b] = [], c(this).click(function () {
                    for (var a in{jqmShow: 1, jqmHide: 1})for (var b in this[a])if (l[this[a][b]])l[this[a][b]].w[a](this);
                    return d
                }));
                this[b].push(a)
            })
...
(function (b) {
    ...
    var c = b.jqDnR, d = c.dnr, e = c.e, g, f, h = function (a, c, h, n) {
        return a.each(function () {
            c = c ? b(c, a) : a;
...
(function (d) {
    ...
    d.jgrid.extend({groupingSetup: function () {
        return this.each(function () {
            ...
            if (null === c || "object" !== typeof c && !d.isFunction(c))this.p.grouping = !1; else if (c.groupField.length) {
        ...
        this.each(function () {
            ...
            for (g = 0; g < m; g++)e = a.groupField[g], h = a.displayField[g], f = b[e], h = null == h ? null : b[h], null == h && (h = f), void 0 !== f && (0 === k ? (a.groups.push({idx: g, dataIndex: e, value: f, displayValue: h, startRow: k,
...
(function (d) {
    ...
    d.jgrid.extend({pivotSetup: function (q, n) {
        ...
        this.each(function () {
            ...
            var x;
            for (a = 0; a < s; a++)x = {name: c.xDimension[a].dataName,
...
(function (b) {
    ...
    b.jgrid.extend({sortableColumns: function (a) {
        ...
        return this.each(function () {
            ...
            var c = this, e, g;
            if (c.grid && !c.p.treeGrid && b.fn.draggable && b.fn.droppable)if (void 0 === b("#jqgrid_dnd")[0] && b("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"), "string" === typeof a && "updateDnD" === a && !0 === c.p.jqgdnd)d(); else if (a = b.extend({drag: function (a) {
            ...
            }, onstart: null, onstop: null, beforedrop: null, ondrop: null, drop_opts: {activeClass: "ui-state-active", hoverClass: "ui-state-hover"}, drag_opts: {revert: "invalid", helper: "clone", cursor: "move", appendTo: "#jqgrid_dnd", zIndex: 5E3}, dragcopy: !1, dropbyname: !1, droppos: "first", autoid: !0, autoidprefix: "dnd_"}, a || {}), a.connectWith)for (a.connectWith =
