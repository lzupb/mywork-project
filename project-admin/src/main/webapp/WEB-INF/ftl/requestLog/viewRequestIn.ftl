...
<#include '../common/common-menu.ftl'/>
    ...
    <#if bean??>
        <div class="profile-contact-links align-left" style="margin-left: 10px;margin-right: 10px;">
            <a href="/requestLog/viewRequestOut?requestId=${bean.requestId!''}"
               class="btn btn-link">
        ...
        <div class="widget-main-sm">
                ...
                <div class="col-lg-6">
                    <div class="input-group">
                                          <span class="input-group-addon fix-width-medium">
                                            ...
                                            <span class="form-control search-form-ipt">
                                              <#if bean.requestStartTime??>
                                              ${bean.requestStartTime?string('yyyy-MM-dd HH:mm:ss.SSS')!''}
                                              </#if>
                                                <span>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                                          <span class="input-group-addon fix-width-medium">
                                            ...
                                            <span class="form-control search-form-ipt">
                                              <#if bean.requestEndTime??>
                                              ${bean.requestEndTime?string('yyyy-MM-dd HH:mm:ss.SSS')!''}
                                              </#if>
                                                <span>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="input-group">
                                          ...
                                          <span class="form-control search-form-ipt">${bean.requestTo!''}<span>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="input-group">
                        <span class="input-group-addon fix-width-medium">接口类型</span>
                        <span class="form-control search-form-ipt">${bean.interfaceType!''}</span>
                    </div>
                </div>
                <div class="col-lg-1">
                </div>
                <div class="col-lg-5">
                    <div class="input-group">
                        <span class="input-group-addon fix-width-medium">是否异常响应</span>
                        <span class="form-control search-form-ipt">${bean.success?string("正常","异常")}</span>
                    </div>
                </div>
            </div>
...
<!-- buss js -->
<script src="<@spring.url '/static/js/buss/requestLog/viewRequestIn.js' />"></script>
</body>
<html>
