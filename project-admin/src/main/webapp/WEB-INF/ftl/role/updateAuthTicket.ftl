                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4" >
                                    <span class="block input-icon input-icon-right">
                                    	<select name="ticketIds" id="ticketIds" class="chosen-select"
                                                data-placeholder="选择可售票务" multiple>
                                        <#list tickets as tic>
                                            <option
                                                <#if beanTicketIdSet?seq_contains(tic.id)>selected</#if>
                                                    value="${tic.id}">
                                            ${tic.name}
                                            </option>
                                        </#list>
...
<!-- buss js -->
<script src="<@spring.url '/static/js/buss/role/updateAuthTicket.js' />"></script>
</body>
<html>
