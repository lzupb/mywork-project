                                ...
                                <div class="widget-body">
                                    <div class="widget-main-sm">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="input-group">
                                                    <span class="input-group-addon">Top1游客</span>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-group">
                                                    <span class="input-group-addon">游客UUCode</span>
                                                    <input name="visitorUucode" type="text"
                                                           class="form-control search-form-ipt">
                                                </div>
                                            </div>
                                            <div class="col-lg-2">
                                                <div class="input-group">
                                                  <span class="input-group-addon">
                                                    ...
                                                    <select name="valid" id="valid" class="chosen-select"
                                                            data-placeholder="全部">
                                                        <option value=""></option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-group">
                                                    <span class="input-group-addon">请求ID</span>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="input-group">
                                                  <span class="input-group-addon">
                                                    ...
                                                    <select name="livingResult" id="livingResult" class="chosen-select"
                                                            data-placeholder="全部">
                                                        <option value=""></option>
...
<!-- buss js -->
<script src="<@spring.url '/static/js/buss/verifyLog/list.js'/>"></script>
