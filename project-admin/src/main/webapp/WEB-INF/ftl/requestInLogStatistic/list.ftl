                                                ...
                                                <div class="input-group">
                                                  <span class="input-group-addon">
                                                    ...
                                                    <select name="statisticsGroup" class="chosen-select"
                                                        ...
                                                        <option value="unitCode">公司</option>
                                                        <option value="requestUri">api</option>
                                                        <option value="unitCode|requestUri">公司|api</option>
...
<#--<script src="<@spring.url '/static/assets/highcharts/highcharts.js' />"></script>-->
    <script src="<@spring.url '/static/js/lib/highchart-utils.js' />"></script>
    <!-- buss js -->
    <script src="<@spring.url '/static/js/buss/requestInLogStatistic/list.js'/>"></script>
    <style>
        .input-group-addon {
            min-width: 90px;
            text-align: right;
