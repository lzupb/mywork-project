...
//                                                           minDate:'#F{$dp.$D(\'requestTimeTo\',{d:-30})}',
                                                ...
                                                <div class="input-group">
                                                  <span class="input-group-addon">
                                                    ...
                                                    <select name="statisticsInterval" class="chosen-select"
                                                        ...
                                                        <option value=""></option>
                                                        <option value="OneMinute">每1分钟</option>
                                            ...
                                            <div class="col-xs-6 col-lg-6 col-md-6 col-sm-6">
                                                <div class="input-group">
                                                  <span class="input-group-addon">
                                                    ...
                                                    <select name="statisticsGroupValue" id="statisticsGroupValue"
                                                            class="chosen-select"
                                                            data-placeholder="选择公司...">
                                                        <option value=""></option>
                                                    <#list units as unit >
...
<!-- buss js -->
<script src="<@spring.url '/static/js/buss/verifyLogStatistics/list.js'/>"></script>
