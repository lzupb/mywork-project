                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                    ...
                                                    <input id="visitorCode" name="visitorCode" type="text"
                                                           placeholder="userId"
                                            ...
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                    ...
                                                    <select name="syncStatus" id="syncStatus" class="chosen-select"
                                                            data-placeholder="请选择状态">
                                                        <option value=""></option>
                                                    <#list syncStatus as sync>
                                                        <option value="${sync.code}">${sync.desc}</option>
                                                    </#list>
                                                    </select>
                                                </div>
                                            </div>
...
<!-- buss js -->
<script src="<@spring.url '/static/js/buss/vgRelation/list.js'/>"></script>
