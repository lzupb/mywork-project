                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="widget-box">
                            <div class="widget-header widget-header-small">
                                <h5 class="widget-title lighter">App版本管理</h5>
                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                    ...
                                                    <input id="versionValue" name="versionValue" type="text" placeholder="版本"
                                            ...
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                    ...
                                                    <input id="versionName" name="versionName" type="text"
                                                           placeholder="版本名称"
                                                           class="form-control search-form-ipt">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                    ...
                                                    <select name="status" id="status" class="chosen-select search-form-ipt">
                                                    <#list status as b >
...
<!-- buss js -->
<script src="<@spring.url '/static/js/buss/appversion/list.js'/>"></script>
