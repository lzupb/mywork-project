                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="widget-box">
                            <div class="widget-header widget-header-small">
                                <h5 class="widget-title lighter">权限组查询</h5>
                            </div>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main-sm">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                  <span class="input-group-addon">权限组编码
                                                  </span>
                                                  <input type="text" id="groupCode" name="groupCode"
	                                              	 class="col-xs-10 col-sm-12" placeholder="编码">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                  <span class="input-group-addon">IDL Group编码
                                                  </span>
                                                  <input type="text" id="bfrGroupCode" name="bfrGroupCode"
	                                              	 class="col-xs-10 col-sm-12" placeholder="IDL Group编码">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                    <a href="update" target="_blank" class=" btn btn-info btn-sm">新增权限
...
<!-- buss js -->
<script src="<@spring.url '/static/js/buss/deviceGroup/list.js'/>"></script>
