                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="widget-box">
                            <div class="widget-header widget-header-small">
                                <h5 class="widget-title lighter">组织查询</h5>
                            </div>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main-sm">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="input-group">
                                                    <a href="update" target="_blank" class=" btn btn-info btn-sm">新增组织
...
<!-- buss js -->
<script src="<@spring.url '/static/js/buss/unit/list.js'/>"></script>
