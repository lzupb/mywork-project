                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-group">
                                                  <span class="input-group-addon">
                                                    ...
                                                    <input name="deviceReqId" type="text"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-group">
                                                  <span class="input-group-addon">
                                                    ...
                                                    <input name="gatewayRequestId" type="text"
                                                           class="form-control search-form-ipt">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="input-group">
                                                  <span class="input-group-addon">
                                                    ...
                                                    <input name="deviceCode" type="text"
                                                           class="form-control search-form-ipt">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
...
<!-- buss js -->
<script src="<@spring.url '/static/js/buss/deviceLog/list.js'/>"></script>
